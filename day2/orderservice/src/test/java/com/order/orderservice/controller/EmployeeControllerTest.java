...
public class EmployeeControllerTest {
	...
	public void testGetAllEmployees() {
		...
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/api/v1/emps", HttpMethod.GET, entity,
				String.class);
	...
	public void testCreateEmployee() {
		...
		ResponseEntity<String> postResponse = restTemplate.postForEntity(getRootUrl() + "/api/v1/saveEmp", employee,
				String.class);
